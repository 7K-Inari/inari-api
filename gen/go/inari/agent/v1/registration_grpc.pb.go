...
const (
	RegistrationService_RegisterCluster_FullMethodName = "/inari.agent.v1.RegistrationService/RegisterCluster"
)
...
func (c *registrationServiceClient) RegisterCluster(ctx context.Context, in *RegisterClusterRequest, opts ...grpc.CallOption) (*RegisterClusterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterClusterResponse)
	err := c.cc.Invoke(ctx, RegistrationService_RegisterCluster_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRegistrationServiceServer) RegisterCluster(context.Context, *RegisterClusterRequest) (*RegisterClusterResponse, error) {
...
func _RegistrationService_RegisterCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterClusterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistrationServiceServer).RegisterCluster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RegistrationService_RegisterCluster_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistrationServiceServer).RegisterCluster(ctx, req.(*RegisterClusterRequest))
	}
...
var RegistrationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "inari.agent.v1.RegistrationService",
	HandlerType: (*RegistrationServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RegisterCluster",
			Handler:    _RegistrationService_RegisterCluster_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "inari/agent/v1/registration.proto",
}
